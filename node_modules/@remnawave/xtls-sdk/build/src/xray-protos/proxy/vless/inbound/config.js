...
exports.protobufPackage = "xray.proxy.vless.inbound";
...
exports.Config = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1: {
                    ...
                    message.clients.push(user_1.User.decode(reader, reader.uint32()));
                    continue;
                }
                case 2: {
                    if (tag !== 18) {
    ...
    fromJSON(object) {
        return {
            ...
            clients: globalThis.Array.isArray(object?.clients) ? object.clients.map((e) => user_1.User.fromJSON(e)) : [],
    ...
    toJSON(message) {
        ...
        if (message.clients?.length) {
            obj.clients = message.clients.map((e) => user_1.User.toJSON(e));
        }
    ...
    fromPartial(object) {
        const message = createBaseConfig();
        message.clients = object.clients?.map((e) => user_1.User.fromPartial(e)) || [];
